// so in this whole file we will create a simple form haveing username feild as input text with place holder and then we will go to create two radio buttons for gender and then sumbit which will take us to sumbit page there we will show a small html code that data is successfully sumbitted and then we will write the data coming from the form to a file and then we will redirect to home page again
