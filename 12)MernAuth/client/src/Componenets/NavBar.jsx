...
const Logout = async()=>{
  ...
  <li onClick={sendVerificationOtp} className='py-1.5 px-2 hover:bg-gray-200 cursor-pointer rounded transition-all'>
    Verify Email
  </li>
)}
  
    <li onClick={Logout} className='py-1.5 px-2 hover:bg-gray-200 cursor-pointer rounded transition-all'>
      Logout
    </li>
  </ul>
</div>
